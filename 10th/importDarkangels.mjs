...
const newCodexFile = readFile("./10th/imports/imported_darkangels.json");
const newCodexUnits = sortObj(JSON.parse(newCodexFile));

const oldCodexFile = readFile("./10th/gdc/darkangels.json");
...
fs.writeFileSync(
  path.resolve(__dirname, `gdc/darkangels.json`),
